...
*The example of the ready-made folder for calculation with already assembled programs is in folder 'Folder for Calculations' in https://github.com/Persova-LMDPHT/FDEM_BfiPF*
