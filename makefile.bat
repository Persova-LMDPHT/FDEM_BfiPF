...
cd ./bound
"g++.exe" -static -O2  -std=c++14 main.cpp stdafx.cpp task2d.cpp -o bound 2>!logg++.txt      
copy bound.exe  %PATHTOCALCFOLDER%Modules  
cd ../ 
:: build Module CalcFreq.exe
cd ./CalcFreq
"g++.exe" -static -O2  -std=c++14 main.cpp -o CalcFreq 2>!logg++.txt 
copy CalcFreq.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module CalcHarm2DHEL.exe
cd ./CalcHarm2DHEL 
"g++.exe" -static -O2  -std=c++14 main.cpp -o CalcHarm2DHEL 2>!logg++.txt
copy CalcHarm2DHEL.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module CalcHarm2DHEL_AV.exe
cd ./CalcHarm2DHEL_AV       
"g++.exe" -static -O2  -std=c++14 main.cpp -o CalcHarm2DHEL_AV 2>!logg++.txt
copy CalcHarm2DHEL_AV.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module CalcHarm2DHEL_U.exe
cd ./CalcHarm2DHEL_U        
"g++.exe" -static -O1  -std=c++14  main.cpp -o CalcHarm2DHEL_U 2>!logg++.txt
...
cd ./Mesh2D_FD
"gfortran.exe" -static -O2  inputF.for Convert_data.for Meah1DZ.for Model_Correct.for Make_NormArea.for -o Mesh2D_FD 2> !loggfortran.txt 
copy Mesh2D_FD.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module OutputSmooth2DHarm_Ax.exe  
cd ./OutputSmooth2DHarm_Ax 
"g++.exe" -static -O2  -std=c++14 -fopenmp SimpleOutput2D.cpp SmoothOutput2D.cpp stdafx.cpp task2d.cpp main.cpp -lpthread  -o OutputSmooth2DHarm_Ax  2> !logg++.txt 
copy OutputSmooth2DHarm_Ax.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module OutputSmooth2DHarm_U.exe  
cd ./OutputSmooth2DHarm_U 
"g++.exe" -static -O2  -std=c++14 -fopenmp main.cpp SmoothOutput2D.cpp stdafx.cpp task2d.cpp -lpthread -o OutputSmooth2DHarm_U  2> !logg++.txt  
copy OutputSmooth2DHarm_U.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module OutputSmoothAV2DHarm_Ax.exe  
cd ./OutputSmoothAV2DHarm_Ax
"g++.exe" -static -O2  -std=c++14 main.cpp SimpleOutput2D.cpp SmoothOutput2D.cpp stdafx.cpp task2d.cpp -o OutputSmoothAV2DHarm_Ax  2> !logg++.txt
...
"g++.exe" -static -O2  -std=c++14 main.cpp SimpleOutput2D.cpp SmoothOutput2D.cpp stdafx.cpp task2d.cpp -o OutputSmoothAV2DHarm_Er  2> !logg++.txt
...
"g++.exe" -static -O2  -std=c++14 main.cpp SimpleOutput2D.cpp SmoothOutput2D.cpp stdafx.cpp task2d.cpp -o OutputSmoothAV2DHarm_Ez  2> !logg++.txt
copy OutputSmoothAV2DHarm_Ez.exe  %PATHTOCALCFOLDER%Modules
cd ../
:: build Module RegularMeshBuilder.exe  
cd ./RegularMeshBuilder
"g++.exe" -static -O2  -std=c++14 BasicOperations.cpp Logging.cpp main.cpp Mesh1D.cpp Mesh2D.cpp Mesh3D.cpp Model.cpp Processing.cpp ReadWrite.cpp -o RegularMeshBuilder  2> !logg++.txt
copy RegularMeshBuilder.exe  %PATHTOCALCFOLDER%Modules  
cd ../
:: build Module SumHarm2D3D.exe  
cd ./SumHarm2D3D
"g++.exe" -static -O2  -std=c++14 main.cpp -o SumHarm2D3D 2>!logg++.txt
...
cd ./UnloadAnomalHarm 
"g++.exe" -static -O2  -std=c++14 GeoCalculatorSP.cpp in_out.cpp stdafx.cpp Tensor.cpp time_approx.cpp T_Mapping.cpp vec_prep_data.cpp -o UnloadAnomalHarm  2> !logg++.txt
