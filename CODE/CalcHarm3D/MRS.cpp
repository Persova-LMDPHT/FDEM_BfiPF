 ...
 *                                                                                          
 *  Earlier uploaded: https://github.com/kiselev2013/MTCalc_with_DFP_COCR/blob/master/Code/COCR_FP/MRS.cpp                                                       
...
void MRS::Mrs(double *x, double *r)
{
	...
	{
		#pragma omp parallel shared(r) private(i) num_threads(ompC.GetNumberOfThreads())
		{
		...
		else
		{
			...
			#pragma omp parallel shared(x) private(i) num_threads(ompC.GetNumberOfThreads())
			{
