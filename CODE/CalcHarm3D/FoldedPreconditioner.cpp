 ...
 *                                                                                                                        
 *  Earlier uploaded: https://github.com/kiselev2013/MTCalc_with_DFP_COCR/blob/master/Code/COCR_FP/FoldedPreconditioner.cpp                                                                                     
...
#pragma omp parallel shared(x, y) private(j, k) num_threads(ompC.GetNumberOfThreads())
{
...
#pragma omp parallel shared(x, y) private(j, t1, t2, k) num_threads(ompC.GetNumberOfThreads())
{
	#pragma omp for nowait
	for (i=0; i<n; i++)
	{
