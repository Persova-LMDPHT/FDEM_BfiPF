 ...
 *  
 *                          
 *  This file contains code for computation of local matrices on hexahedrons
 *  
 *  Earlier uploaded: https://github.com/kiselev2013/MTCalc_with_DFP_COCR/blob/master/Code/OutputNu/Hex_Local_Matrix.cpp 
