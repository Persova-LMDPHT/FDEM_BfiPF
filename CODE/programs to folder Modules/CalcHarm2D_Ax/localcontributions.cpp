 ...
 * 
 *                       FDEM_BfiPF 
 *  This file contains code for calculating 2D local matirxes
 * 
 * 
...
//------------------------------------------------------ 
int GetStiffnessMatrix(const double &r0, const double &z0,const double &r3, const double &z3,double m[4][4])
{
...
//------------------------------------------------------ 
int GetMassMatrix(const double &r0, const double &z0,const double &r3, const double &z3,double m[4][4])
{
	double h1=r3-r0, h2=z0-z3, rk=r0;
	double r11, r12, r22, z11, z12, z22;
...
int GetStiffnessMatrix0(const double &r0, const double &z0,const double &r3, const double &z3,double m[4][4])
{
	double h1=r3-r0, h2=z0-z3, rk=r0;
	double r11, r12, r22, z11, z12, z22;
...
int GetMatrixDr(const double &r0, const double &z0,const double &r3, const double &z3,double m[4][4])
{
...
int GetMatrixDz(const double &r0, const double &z0,const double &r3, const double &z3,double m[4][4])
{
	double hrk=r3-r0, hzk=z0-z3, rk=r0;
