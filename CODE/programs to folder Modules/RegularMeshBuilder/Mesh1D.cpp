 ...
 *
 *  Earlier uploaded: https://github.com/kiselev2013/A-E_Formulations_3D_TimeDomain_EM_HorizontalGroundedWireSource/blob/master/CODE/programs%20to%20folder%20Modules/RegularMeshBuilder/Mesh1D.cpp
...
namespace Mesh1D
{
	...
	void AddRefinementCoordinates(vector<double> &mesh1D,const pair<int, int> interval, vector<double> &coordinates)
	{
