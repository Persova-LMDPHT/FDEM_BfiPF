...
struct SmoothOutput2D
{
	...
	int Init(int rec_qr,int rec_qz, int p_kpnt, int p_krect, PointRZ *p_rec, PointRZ *p_pnt, Rect *p_rect, int MatFlag, int *matrec, double *p_sigma,
		int p_nreg, int p_qr, int p_qz, int *p_reg, double *p_rm, double *p_zm);
	void Output_dArdz(double *v2s,double *v2c,double *results,double *resultc,int OutType,vector<int> &RecToSourceB);
	void Output_Er(double *v2as,double *v2ac,double *v2vs,double *v2vc,double *results,double *resultc,int OutType,vector<int> &RecToSourceE);
	...
	void Output_Er(double *v2as, double *v2ac, double *v2vs, double *v2vc, double *results, double *resultc, int OutType);
};
